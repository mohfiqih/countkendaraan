...
<head>
     ...
     function closePopup() {
          ...
          hitungOutput(); // Memanggil fungsi hitungOutput setelah menutup popup
     }
     ...
     function hitungOutput() {
          ...
          // Menghitung output
          var output = parseFloat(L) + parseFloat(BK) + parseFloat(G);
                              ...
                              <div class="bg-white rounded-lg p-8">
                                   ...
                                   <form>
                                             ...
                                             <div class="md:flex">
                                                  <table class="min-w-full divide-y divide-gray-200">
                                                       ...
                                                       <tbody class="bg-white divide-y divide-gray-200">
                                                            <tr>
                                                                 <td id="output" class="px-6 py-4 whitespace-nowrap">
                                                                 </td>
                                                            </tr>
                                                       </tbody>
                                                  </table>
                                        ...
                                        <div class="flex justify-end">
                                             <button onclick="hitungOutput()" type="submit"
                         ...
                         <div class="bg-white mb-10 p-6 rounded-lg shadow">
                              <div class="md:flex">
                                   <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                             <tr>
                                                  <td id="output" class="px-6 py-4 whitespace-nowrap"></td>
                                             </tr>
                                        </tbody>
                                   </table>
                              </div>
